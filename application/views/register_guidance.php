...
<html>
    ...
    <div class="login-logo">
        <a href="#"><b>Register Guidance</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
        <div class="card-body login-card-body">
        <p class="login-box-msg">Register as Guidance</p>

        <form action="" id="teacherRegisterForm">
            <div class="input-group mb-3">
            <input name="id_number" type="number" class="form-control" placeholder="ID Number: ">
            ...
            <div class="row">
            <div class="col-8">
                Go <a href="<?=base_url('main/teacherMode')?>">Back</a> / <a href="<?=base_url('main/adminMode')?>">Sign-in</a>
            </div>
            <!-- /.col -->
            <div class="col-4">

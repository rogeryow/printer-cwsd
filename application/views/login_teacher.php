...
<html>
    ...
    <div class="card">
        ...
        <p class="login-box-msg">Sign in to Teachers' Account</p>

        <form action="" id="teacherLoginForm">
            ...
            <div class="row">
            <div class="col-8">
                Go <a href="<?=base_url()?>">Back</a> / <a href="<?=base_url('main/teacherRegister')?>">Register</a>
            </div>
            <!-- /.col -->
            <div class="col-4">
